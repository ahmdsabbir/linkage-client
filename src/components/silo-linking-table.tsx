          ...
          <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div className="overflow-hidden border border-gray-200  md:rounded-lg">
              <table className="min-w-full divide-y divide-gray-200 ">
                <thead className="bg-gray-50 font-medium text-gray-800">
                  <tr>
                    <th
                      scope="col"
                      className="py-3.5 px-4 text-left font-normal  text-sm rtl:text-right"
                    >
                    ...
                    <th
                      scope="col"
                      className="px-12 py-3.5 text-left font-normal  text-sm rtl:text-right "
                    >
                    ...
                    <th
                      scope="col"
                      className="px-4 py-3.5 text-left font-normal text-sm rtl:text-right "
                    >
                      <button className="flex items-center gap-x-2">
                        <span>Status</span>
                        <svg
...
export default SiloLinkingTable;
