  ...
  return (
    <div className="mt-4 w-full max-w-sm  transform rounded-md bg-white p-6 shadow-md shadow-primary/10 transition-all">
      <div className="space-y-2">
        ...
        <div className="flex flex-col space-y-0">
          <span className="text-gray-400 text-sm">Support Post</span>
          <span className=" font-semibold text-gray-600 text-base">
            {"Why Is This Pillar So Tall?"}
          </span>
        </div>
        <div className="flex flex-col space-y-0">
          <span className="text-gray-400 text-sm">Support Post</span>
          <span className=" font-semibold text-gray-600 text-base ">
            {"What Is the Best Color for A Pillar?"}
          </span>
        </div>
        <div className="flex flex-col space-y-0">
          <span className="text-gray-400 text-sm">Support Post</span>
          <span className=" font-semibold text-gray-600 text-base ">
            {"How Long Does a Pillar Live?"}
          </span>
        </div>
        <div className="flex flex-col space-y-0">
          <span className="text-gray-400 text-sm ">Support Post</span>
        ...
        <div className="flex flex-col space-y-0">
          <span className="text-gray-400 text-xs">Support Post</span>
